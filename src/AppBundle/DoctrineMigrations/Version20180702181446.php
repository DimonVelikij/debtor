 ...
 */
class Version20180702181446 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE events ADD type VARCHAR(255) NOT NULL, DROP parent_id, DROP time_perform_action, DROP is_start, DROP is_judicial, CHANGE slug alias VARCHAR(255) NOT NULL');
